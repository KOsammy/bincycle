        ...
        riderWorkingRef.addListenerForSingleValueEvent(new ValueEventListener() { // Use addListenerForSingleValueEvent to retrieve data only once
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.hasChildren()) {
                    ...
                    ArrayList<Double> locationMap = ((ArrayList<Double>) snapshot.getValue());
                    if (locationMap != null ) {
                        Double locationLat = locationMap.get(0); // Cast to Double
                        Double locationLng = locationMap.get(1);
                      ...
                      if (locationLat != null && locationLng != null) {
                            ...
                            Log.d("RiderLocation", "location data: "+riderLatLng);
